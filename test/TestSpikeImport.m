...
classdef TestSpikeImport < TestMatlabSuite
    ...
    methods
        ...
        function testShouldSaveSpikeRelatedPhaseDerivedResponses(self)
            ...
            expectedSpikeCount = numel(...
                data.Spike.thPhaseHilb(desc.lfpStartIndex <= data.Spike.res(1:length(data.Spike.thPhase)) & ...
                data.Spike.res(1:length(data.Spike.thPhase)) <= desc.lfpEndIndex)...
                );
