...
classdef TestEpochImport < MatlabTestCase
    ...
    methods
        ...
        function [epoch,data,params,desc] = importSingleEpoch(self)
            ...
            epochProtocol = self.context.insertProtocol('Epoch Protocol',...
                'Epoch protocol');
            
            analysisProtocol = self.context.insertProtocol('Analysis Protocol',...
                'Analysis Protocol');
            
            [~,grp, sourceMap] = importParameters(self.context,...
                project,...
                params,...
                data.xml,...
                expProtocol,...
