function epoch = importEpoch(group, protocol, params, data, epochDescriptor, inputSources)
    import ovation.*;
    ...
    % TODO convert ElecGp to struct array?
    ...
    importAnalysisRecords(epoch, params, data, epochDescriptor);
...
function epoch = importAnalysisRecords(epoch, params, data, epochDescriptor)
    import ovation.*;
